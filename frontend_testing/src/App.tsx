  ...
  return (
    <div className=" fadeIn padding-px-0 margin-px-0 width-percent-100 height-percent-100">
      <div className="grid-template-row padding-percent-0">
        <div className="  bg-white flex-row justify-space-between margin-percent-0 padding-percent-0 width-percent-100 flex-row justify-center align-items-center txt-center height-px-100">
        ...
        <div className=" flex-col pad-pixel-0 align-center justify-center txt-center height-percent-100">
